            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              >
                <div className="relative bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/10 rounded-2xl p-8 hover:border-[var(--gold)]/30 transition-all duration-400">
                  ...
                  <div className="inline-flex items-center gap-2 px-5 py-3 bg-[var(--gold)] text-[var(--noir)] rounded-lg font-semibold text-sm hover:bg-[var(--gold-light)] transition-all duration-300">
                    Commander
