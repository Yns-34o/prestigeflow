        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 text-center w-full relative z-10">
          <Reveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              >
                <div className="relative bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/10 rounded-3xl p-10 hover:border-[var(--gold)]/30 transition-all duration-500">
                  <div className="w-24 h-24 mx-auto mb-8 bg-[var(--noir-light)] border border-[var(--noir-border)] rounded-2xl flex items-center justify-center group-hover:border-[var(--gold)] transition-all duration-300">
                    <img
                  ...
                  <div className="inline-flex items-center gap-3 px-6 py-4 bg-[var(--gold)] text-[var(--noir)] rounded-xl font-semibold text-base hover:bg-[var(--gold-light)] transition-all duration-300">
