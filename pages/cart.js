                        ...
                        <div className="flex gap-4">
                          ...
                          >
                            <div className="flex items-center justify-center gap-3">
                              <div className="w-11 h-11 rounded-lg flex items-center justify-center bg-[var(--noir-light)] border border-[var(--noir-border)] group-hover:border-[var(--gold)] transition-all duration-300">
                                <img
