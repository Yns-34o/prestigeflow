          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {deliveryLinks.map((link) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-[var(--noir-light)] border border-[var(--noir-border)] group-hover:border-[var(--gold)] transition-all duration-300">
                    {link.name === 'Uber Eats' ? (
                      <img
