            ...
            {items.length > 0 && (
              <div className="border-t border-white/5 px-6 py-5">
                ...
                <div className="mt-5 pt-5 border-t border-white/5">
                  <p className="text-[var(--text-tertiary)] text-[10px] tracking-[0.2em] uppercase mb-4 text-center">Ou commandez via</p>
                  <div className="flex gap-3">
                    ...
                    >
                      <div className="flex items-center justify-center gap-2">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-[var(--noir-light)] border border-[var(--noir-border)] group-hover:border-[var(--gold)] transition-all duration-300">
                          <img
