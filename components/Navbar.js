          ...
          <div className="hidden lg:flex h-20 items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-0.5 overflow-x-auto scrollbar-hide">
                {links.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`relative px-3 py-2 text-[11px] tracking-[0.15em] uppercase font-medium transition-colors duration-300 rounded-lg whitespace-nowrap flex-shrink-0 ${
                      pathname === link.href
                        ? 'text-[var(--gold)]'
                        : 'text-[var(--text-secondary)] hover:text-white'
                    }`}
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <a
                ...
                className="group px-1.5 py-1.5 rounded-lg hover:bg-white/5 transition-all duration-300"
              >
                <img
                  src="/uber-eats-logo.svg"
                  alt="Uber Eats"
                  className="h-4 opacity-60 group-hover:opacity-100 transition-opacity"
                />
              </a>
              <a
          ...
          >
            ...
            >
              <div className="w-8 h-8 border border-[var(--gold)] rounded-lg rotate-45 flex items-center justify-center">
                <span className="font-display text-[var(--gold)] text-xs font-bold ">P</span>
              </div>
